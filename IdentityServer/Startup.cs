...
namespace IdentityServer
{
    public class Startup
    {
            ...
            IGlobals globals)
        {
            ...
            //    var context1 = serviceScope.ServiceProvider.GetRequiredService<ConfigurationDbContext>();
            //    bool isCreated1 = context1.Database.EnsureCreated();

            //    var context2 = serviceScope.ServiceProvider.GetRequiredService<ApplicationDbContext>();
            //    bool isCreated2 = context2.Database.EnsureCreated();
            //}
