...
namespace Variables
{
    public class Globals : IGlobals
    {
        ...
        public string CONNECTION_STRING { get; set; } = "Server=CS-DEV-SARAVANA;Database=AspIdUsers;User Id=sa;Password=123456;MultipleActiveResultSets=true";
        ...
        public string ADMIN_PASSWORD { get; set; } = "123456@Aa";
